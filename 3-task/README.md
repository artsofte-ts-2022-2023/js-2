...
Первый параметр - объект, второй - имя поля, которое нужно защитить от изменения. Имя может быть только строкой, не состоящей только из пробелов и ненулевой длины.
